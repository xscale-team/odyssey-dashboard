...
>
> **What To Do Next:** Fix the remaining Session 31 production brand-owner QA findings before more growth testing: unify bot/dashboard metrics, reinstate the product-image verification gate in native ad generation, hide failed regenerated variants from the ready gallery, add OCR/compliance-backed creative review, and normalize generated images to 1080x1080. Full notes: `docs/qa-runs/2026-04-26-brand-owner-ad-bot-qa.md`.
