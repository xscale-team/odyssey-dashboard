...
- [ ] **Ad workflow can promise 3 ads but persist 2** - Session 45 production owner QA confirmed the image gate and generated assets, but the final persisted `batch-json` contained 2 creatives after the bot promised a 3-ad starter batch. Need tool-level requested-count enforcement or retry/failure disclosure so a partial batch is never presented as complete.
