...
> **Last updated: 2026-04-26 (Session 34)**
> Goal-driven, not timeline-driven. Ship MVP when pipeline is bulletproof.
>
> **What To Do Next:** Continue production brand-owner QA on the remaining Session 31-34 gaps: unify bot/dashboard metrics, mark failed/regenerated DB assets as non-ready, harden long-batch SSE/reconnect behavior, add OCR/compliance-backed creative review, and turn final ad artifacts into a persistent review CTA. Full notes: `docs/qa-runs/2026-04-26-brand-owner-ad-bot-qa.md` and `docs/qa-runs/2026-04-26-deep-brand-owner-production-qa.md`.
...
- [ ] **Stale failure memories appear in fresh chats after a hotfix** - Session 33 fresh chat showed a saved "Ad batch generator failing on HashiAid" diagnostic from before the Kie text-to-image hotfix. Useful internally, but confusing as a customer-facing "while you were gone" card once the issue is fixed.
