...
> **Last updated: 2026-04-28 (Session 71)**
> Goal-driven, not timeline-driven. Ship MVP when pipeline is bulletproof.
>
> **What To Do Next:** Session 71 fixed v2 live status labels for native ad-generation streams. Next QA pass should run a fresh owner chat through one single ad and one batch, watching that the live panel moves from tool call to "Designer: Generating..." to per-ad ready labels, with no stale "Thinking..." state during image generation.
