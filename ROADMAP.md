...
>
> **What To Do Next:** Continue production brand-owner QA after Session 36 deploy verification. Remaining gaps: unify bot/dashboard metrics, mark failed/regenerated DB assets as non-ready, harden long-batch SSE/reconnect behavior, add OCR-backed creative review, make `create_review_batch`/Open Review CTA reliable for generated ads, and replace the brand-name checker's crude Title Case heuristic with entity-aware logic. Full notes: `docs/qa-runs/2026-04-26-brand-owner-ad-bot-qa.md` and `docs/qa-runs/2026-04-26-deep-brand-owner-production-qa.md`.
