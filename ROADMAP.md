...
> **Last updated: 2026-04-28 (Session 70)**
> Goal-driven, not timeline-driven. Ship MVP when pipeline is bulletproof.
>
> **What To Do Next:** Session 70 hardened public preview ad generation so GPT Image 2 only runs with a downloaded real product image. After deploy, smoke `/preview` with a product-image-rich store and confirm generated ads still appear; if a site has no product images, preview should fall back to planned ad cards instead of generating generic visuals.
